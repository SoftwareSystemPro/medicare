      ...
      <div className={styles.blogs_boxs}>
       ...
       return (
          <div key={index} className={styles.blogs_card}>
            ...
            <p style={{whiteSpace : "pre-wrap"}}>{locale == 'ru' ? elem?.descriptionRu.text?.slice(0  ,300) : locale == 'en' ? elem?.descriptionEn.text?.slice(0  ,300) :  locale == 'uz' ? elem?.descriptionUz.text?.slice(0  ,300) : elem?.descriptionRu.text?.slice(0  ,300) }</p>
